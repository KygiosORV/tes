...
if (empty($lista)) {
    echo '<font size=3.5 color="white"><font class="badge badge-danger">#Reprovadas </i></font> <font class="badge badge-warning">『 ★ Bete Enter Your CC First ★ 』</i></font> <font class="badge badge-secondary"> </font><br></br>';
    die();
};
...
echo '<font size=3.5 color="white"><font class="badge badge-success">#Aprovadas </i></font> <font class="badge badge-success"> '.$lista.' </i></font> <font size=3.5 color="green"> <font class="badge badge-success"> 『 ★ CVV Charged $0.01 | [Approved] ★ 』 </font> <font class="badge badge-secondary"> Time Taken: '.$time.'s</font> <font class="badge badge-secondary"> Gate: Braintree Charge $0.01</font> <font class="badge badge-secondary"> </font><br></br>';
}

#-----[CVV AVS Failed Response]-----#

elseif (strpos($result, 'Gateway Rejected: avs')){
echo '<font size=3.5 color="white"><font class="badge badge-success">#Aprovadas </i></font> <font class="badge badge-success"> '.$lista.' </i></font> <font size=3.5 color="green"> <font class="badge badge-success"> 『 ★ CVV MATCHED | ['.$Respo.'] ★ 』 </font> <font class="badge badge-secondary"> Time Taken: '.$time.'s</font> <font class="badge badge-secondary"> Gate: Braintree Charge $0.01</font> <font class="badge badge-secondary"> </font><br></br>';
}
...
echo '<font size=3.5 color="white"><font class="badge badge-success">#Aprovadas </i></font> <font class="badge badge-success"> '.$lista.' </i></font> <font size=3.5 color="green"> <font class="badge badge-success"> 『 ★ CCN LIVE | ['.$Respo.'] ★ 』 </font> <font class="badge badge-secondary"> Time Taken: '.$time.'s</font> <font class="badge badge-secondary"> Gate: Braintree Charge $0.01</font> <font class="badge badge-secondary"> </font><br></br>';
}

#-----[DEAD Response]-----#

elseif (strpos($result, $Respo)){
echo '<font size=3.5 color="white"><font class="badge badge-danger">#Reprovadas </i></font> <font class="badge badge-secondary"> '.$lista.' </i></font><font size=3.5 color="red"> <font class="badge badge-warning">『 ★ Declined | ['.$Respo.'] ★ 』</i></font> <font class="badge badge-secondary"> Time Taken: '.$time.'s</font> <font class="badge badge-secondary"> Gate: Braintree Charge $0.01</font> <font class="badge badge-secondary"> </font><br></br>';
}

else {
echo '<font size=3.5 color="white"><font class="badge badge-danger">#Reprovadas </i></font> <font class="badge badge-secondary"> '.$lista.' </i></font><font size=3.5 color="red"> <font class="badge badge-warning">『 ★ Declined </i></font> <font class="badge badge-secondary"> Time Taken: '.$time.'s</font> <font class="badge badge-secondary"> Gate: Braintree Charge $0.01</font> <font class="badge badge-secondary"> </font><br></br>';
